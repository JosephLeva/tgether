...
def lambda_handler(event, context):
    ...
    cursor.execute("INSERT INTO contractitems (contractid, itemname, itemprice) VALUES (%s,%s,%s)" , (contractid,itemname,itemprice) )
    conn.commit()
    ...
    return {
        'statusCode': 200,
        'body': json.dumps({"itemname": itemname, "itemprice":itemprice}),
        'headers': {
